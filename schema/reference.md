...
Generated from the property ledger by `cargo xtask gen-schema` — **do not edit**. Schema v1, lini 1.0.0-rc.1. The machine-readable form, with one compiled example per property, is `lini.schema.json`.
