...
| **1.0.0-alpha.2** ✓ (2026-07-18) | Charts (`CHART-DRAW-alpha23.md`, combined round) | per-datum paint + labels, time axes, the `format:` machinery + axes/tooltips. |
| **1.0.0-alpha.3** ✓ (2026-07-18) | Drawing measurement (`CHART-DRAW-alpha23.md`, combined round) | dimension clearance + bounds-derived packing, inference + `project:`, boxed datums + datum identities, halos, internal threads, pattern copy ids, fan leaders. |
