...
| `\|field\|` | `\|block\|` | `font-size: 11; font-weight: normal; color: --footer-color` | A **title-block field's caption**, over its value — quieter in size, weight, and tone ([SPEC 15.8](#158-assemblies-views-sheets--titles)). |
