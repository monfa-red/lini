...
glyphs! {
    ...
    "sch-c" => 64.0, 16.0, [(0.0, 8.0), (64.0, 8.0)], [
        (Line, r#"<path d="M 0 8 L 29 8 M 35 8 L 64 8"/>"#),
        (Solid, r#"<path d="M 27.5 0 L 30.5 0 L 30.5 16 L 27.5 16 Z M 33.5 0 L 36.5 0 L 36.5 16 L 33.5 16 Z"/>"#),
    ];
    "sch-c-polarized" => 64.0, 20.0, [(0.0, 12.0), (64.0, 12.0)], [
        (Line, r#"<path d="M 0 12 L 29 12 M 39 4 A 18 18 0 0 0 39 20 M 37 12 L 64 12 M 6 2 L 12 2 M 9 0 L 9 5"/>"#),
        (Solid, r#"<path d="M 27.5 4 L 30.5 4 L 30.5 20 L 27.5 20 Z"/>"#),
    ];
    ...
    "sch-gnd" => 16.0, 15.0, [(8.0, 0.0)], [(Line, r#"<path d="M 8 0 L 8 5 M 1 5 L 15 5 L 8 15 Z"/>"#)];
    ...
    "sch-power" => 16.0, 14.0, [(8.0, 14.0)], [(Line, r#"<path d="M 8 14 L 8 0 M 2 6 L 8 0 L 14 6"/>"#)];
    "sch-q-nfet" => 56.0, 32.0, [(0.0, 16.0), (56.0, 8.0), (56.0, 24.0)], [
        (Line, r#"<path d="M 0 16 L 20 16 M 20 6 L 20 26 M 28.5 8 L 56 8 M 28.5 24 L 56 24 M 28.5 16 L 44 16 L 44 24"/>"#),
        (Solid, r#"<path d="M 25.5 6 L 28.5 6 L 28.5 11.3 L 25.5 11.3 Z M 25.5 13.3 L 28.5 13.3 L 28.5 18.7 L 25.5 18.7 Z M 25.5 20.7 L 28.5 20.7 L 28.5 26 L 25.5 26 Z M 28 16 L 37 12.8 L 37 19.2 Z"/>"#),
    ];
    "sch-q-nfet-circled" => 56.0, 32.0, [(0.0, 16.0), (56.0, 8.0), (56.0, 24.0)], [
        (Line, r#"<path d="M 0 16 L 20 16 M 20 6 L 20 26 M 28.5 8 L 56 8 M 28.5 24 L 56 24 M 28.5 16 L 44 16 L 44 24 M 13 16 A 15 15 0 1 1 43 16 A 15 15 0 1 1 13 16"/>"#),
        (Solid, r#"<path d="M 25.5 6 L 28.5 6 L 28.5 11.3 L 25.5 11.3 Z M 25.5 13.3 L 28.5 13.3 L 28.5 18.7 L 25.5 18.7 Z M 25.5 20.7 L 28.5 20.7 L 28.5 26 L 25.5 26 Z M 28 16 L 37 12.8 L 37 19.2 Z"/>"#),
    ];
    "sch-q-npn" => 56.0, 32.0, [(0.0, 16.0), (56.0, 3.0), (56.0, 29.0)], [
        (Line, r#"<path d="M 16 16 A 14 14 0 1 1 44 16 A 14 14 0 1 1 16 16 M 0 16 L 24 16 M 24 12 L 40 3 L 56 3 M 24 20 L 40 29 L 56 29"/>"#),
        (Solid, r#"<path d="M 22.5 8 L 25.5 8 L 25.5 24 L 22.5 24 Z M 36.8 27.2 L 27.39 25.58 L 30.52 20 Z"/>"#),
    ];
    "sch-q-pfet" => 56.0, 32.0, [(0.0, 16.0), (56.0, 8.0), (56.0, 24.0)], [
        (Line, r#"<path d="M 0 16 L 20 16 M 20 6 L 20 26 M 28.5 8 L 56 8 M 28.5 24 L 56 24 M 28.5 16 L 44 16 L 44 24"/>"#),
        (Solid, r#"<path d="M 25.5 6 L 28.5 6 L 28.5 11.3 L 25.5 11.3 Z M 25.5 13.3 L 28.5 13.3 L 28.5 18.7 L 25.5 18.7 Z M 25.5 20.7 L 28.5 20.7 L 28.5 26 L 25.5 26 Z M 37 16 L 28 19.2 L 28 12.8 Z"/>"#),
    ];
    "sch-q-pfet-circled" => 56.0, 32.0, [(0.0, 16.0), (56.0, 8.0), (56.0, 24.0)], [
        (Line, r#"<path d="M 0 16 L 20 16 M 20 6 L 20 26 M 28.5 8 L 56 8 M 28.5 24 L 56 24 M 28.5 16 L 44 16 L 44 24 M 13 16 A 15 15 0 1 1 43 16 A 15 15 0 1 1 13 16"/>"#),
        (Solid, r#"<path d="M 25.5 6 L 28.5 6 L 28.5 11.3 L 25.5 11.3 Z M 25.5 13.3 L 28.5 13.3 L 28.5 18.7 L 25.5 18.7 Z M 25.5 20.7 L 28.5 20.7 L 28.5 26 L 25.5 26 Z M 37 16 L 28 19.2 L 28 12.8 Z"/>"#),
    ];
    "sch-q-pnp" => 56.0, 32.0, [(0.0, 16.0), (56.0, 3.0), (56.0, 29.0)], [
        (Line, r#"<path d="M 16 16 A 14 14 0 1 1 44 16 A 14 14 0 1 1 16 16 M 0 16 L 24 16 M 24 12 L 40 3 L 56 3 M 24 20 L 40 29 L 56 29"/>"#),
        (Solid, r#"<path d="M 22.5 8 L 25.5 8 L 25.5 24 L 22.5 24 Z M 28.48 22.52 L 37.89 24.14 L 34.76 29.72 Z"/>"#),
    ];
