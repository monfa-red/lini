...
glyphs! {
    ...
    "sch-bz" => 64.0, 24.0, [(0.0, 12.0), (64.0, 12.0)], [(Line, r#"<path d="M 0 12 L 24 12 M 24 2 L 24 22 M 24 2 A 10 10 0 0 1 24 22 M 34 12 L 64 12"/>"#)];
    ...
    "sch-opamp" => 64.0, 64.0, [(64.0, 32.0), (0.0, 12.0), (0.0, 52.0)], [(Line, r#"<path d="M 12 0 L 60 32 L 12 64 Z M 0 12 L 12 12 M 0 52 L 12 52 M 60 32 L 64 32 M 17 12 L 25 12 M 21 8 L 21 16 M 17 52 L 25 52"/>"#)];
